...
type Usuarios struct {
	...
	Nombre    string `orm:"column(nombre);size(250)"`
	Email     string `orm:"column(email);size(250)"`
	Password  string `orm:"column(password);size(250)"`
	Telefono  int    `orm:"column(telefono)"`
	Pais      string `orm:"column(pais);size(250);null"`
	Ciudad    string `orm:"column(ciudad);size(250);null"`
	Direccion string `orm:"column(direccion);size(250);null"`
}
